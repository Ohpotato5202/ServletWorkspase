   ...
   <div id='emp-container'>
      ...
      <div id="search-container">
         <form name="empSearchFrm">
            ...
            <table id="tbl-search">
               <c:set var="jobCodeArr" value="${requestScope.param.jobCodeArr }"/>
               <tr>
                  <th>직급</th>
                  <td>
               ...
               <tr>
                  <th colspan="2"><input type="submit" id="btn-search"
                     value="검색" /></th>
               </tr>
            </table>
         </form>
      ...
      <table class="tbl-emp">
         ...
         <tbody>
            ...
            <c:forEach items="${list}" var="emp" varStatus="vs">
               <tr>
                  <td>${vs.count}</td>
                  <td><a href="/mybatis/emp/updateEmp.do?empId=${emp.EMP_ID }">${emp.EMP_ID}</a>
                  </td>
                  <td>${emp.EMP_NAME}</td>
